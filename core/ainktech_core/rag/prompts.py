...
def _define_custom_prompts() -> CustomPromptsDict:
    ...
    # Prompt for RAG
    # ---------------------------------------------------------------------------
    system_message_template = f"Your name is ainktech. You're a helpful assistant. Today's date is {today_date}. "
    ...
    # ---------------------------------------------------------------------------
    system_message_template = (
        f"Your name is ainktech. You're a helpful assistant. Today's date is {today_date}."
    )
    system_message_template += """
