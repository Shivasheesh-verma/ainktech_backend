...
from ainktech_core.llm_tools.llm_tools import LLMToolFactory
from ainktech_core.rag.entities.chat import ChatHistory
from ainktech_core.rag.entities.config import DefaultRerankers, NodeConfig, RetrievalConfig
...
class ainktechQARAGLangGraph:
    def __init__(
        ...
        *,
        ...
        """
        Construct a ainktechQARAGLangGraph object.
    ...
    def filter_history(self, state: AgentState) -> AgentState:
        ...
        AIMessage(content="Chloé est une salariée travaillant pour l'entreprise ainktech en tant qu'AI Engineer,
