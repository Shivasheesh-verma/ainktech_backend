...
from ainktech_core.config import MegaparseConfig
from rapidfuzz import process, fuzz


from ainktech_core.base_config import ainktechBaseConfig
from ainktech_core.processor.splitter import SplitterConfig
from ainktech_core.rag.prompts import CustomPromptsModel
from ainktech_core.llm_tools.llm_tools import LLMToolFactory, TOOLS_CATEGORIES, TOOLS_LISTS
...
class BrainConfig(ainktechBaseConfig):
...
class LLMConfig(ainktechBaseConfig):
...
class LLMEndpointConfig(ainktechBaseConfig):
...
class RerankerConfig(ainktechBaseConfig):
...
class ConditionalEdgeConfig(ainktechBaseConfig):
...
class NodeConfig(ainktechBaseConfig):
    name: str
...
class WorkflowConfig(ainktechBaseConfig):
    name: str | None = None
...
class RetrievalConfig(ainktechBaseConfig):
...
class ParserConfig(ainktechBaseConfig):
    splitter_config: SplitterConfig = SplitterConfig()
    megaparse_config: MegaparseConfig = MegaparseConfig()


class IngestionConfig(ainktechBaseConfig):
    parser_config: ParserConfig = ParserConfig()


class AssistantConfig(ainktechBaseConfig):
