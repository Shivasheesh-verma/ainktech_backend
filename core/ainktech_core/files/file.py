...
class ainktechFileSerialized(BaseModel):
    id: UUID
    brain_id: UUID
    path: Path
...
class ainktechFile:
    ...
    def __repr__(self) -> str:
        return f"ainktechFile-{self.id} original_filename:{self.original_filename}"
    ...
    def serialize(self) -> ainktechFileSerialized:
        return ainktechFileSerialized(
            id=self.id,
    ...
    @classmethod
    def deserialize(cls, serialized: ainktechFileSerialized) -> Self:
        return cls(
            id=serialized.id,
