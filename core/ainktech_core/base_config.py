...
class ainktechBaseConfig(BaseModel):
    """
    Base configuration class for ainktech.

    This class extends Pydantic's BaseModel and provides a foundation for
    configuration management in ainktech-core.
    ...
    def from_yaml(cls, file_path: str | Path) -> Self:
        ...
        Returns:
            ainktechBaseConfig: An instance of the class initialized with the data from the YAML file.
        """
        # Load the YAML file
