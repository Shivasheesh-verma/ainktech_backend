...
from ainktech_core.rag.entities.config import LLMEndpointConfig
from ainktech_core.rag.entities.models import ChatMessage
from ainktech_core.files.file import ainktechFileSerialized
...
class LocalStorageConfig(BaseModel):
    ...
    storage_path: Path
    files: dict[UUID, ainktechFileSerialized]
