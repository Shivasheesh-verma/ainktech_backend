...
from ainktech_core.rag.entities.models import ParsedRAGResponse
from ainktech_core.rag.ainktech_rag import ainktechQARAG
from rich.console import Console
from rich.panel import Panel

from ainktech_core.brain.info import BrainInfo, ChatHistoryInfo
from ainktech_core.brain.serialization import (
    BrainSerialized,
    EmbedderConfig,
    FAISSConfig,
    LocalStorageConfig,
...
from ainktech_core.rag.entities.chat import ChatHistory
from ainktech_core.rag.entities.config import RetrievalConfig
from ainktech_core.files.file import load_qfile
from ainktech_core.llm import LLMEndpoint
from ainktech_core.rag.entities.models import (
    ParsedRAGChunkResponse,
    ainktechKnowledge,
    SearchResult,
)
from ainktech_core.processor.registry import get_processor_class
from ainktech_core.rag.ainktech_rag_langgraph import ainktechQARAGLangGraph
from ainktech_core.storage.local_storage import LocalStorage, TransparentStorage
from ainktech_core.storage.storage_base import StorageBase
...
class Brain:
    ...
    * Use the *ainktech* workflow for the retrieval augmented generation.
    A Brain is able to:
    ...
    * Stream the answer to the question.
    ...
    async def asearch(
        ...
        results = await brain.asearch("Why everybody loves ainktech?")
    ...
    async def ask_streaming(
        ...
        rag_pipeline: Type[Union[ainktechQARAG, ainktechQARAGLangGraph]] | None = None,
        list_files: list[ainktechKnowledge] | None = None,
        ...
        Args:
            ...
            rag_pipeline (Type[Union[ainktechQARAG, ainktechQARAGLangGraph]] | None): The RAG pipeline to use.
        list_files (list[ainktechKnowledge] | None): The list of files to include in the RAG pipeline.
        ...
        if rag_pipeline is None:
            rag_pipeline = ainktechQARAGLangGraph
