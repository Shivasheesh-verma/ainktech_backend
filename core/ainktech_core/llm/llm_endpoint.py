...
from ainktech_core.brain.info import LLMInfo
from ainktech_core.rag.entities.config import DefaultModelSuppliers, LLMEndpointConfig
from ainktech_core.rag.utils import model_supports_function_calling
...
class LLMEndpoint:
    ...
    def from_config(cls, config: LLMEndpointConfig = LLMEndpointConfig()):
        ...
        try:
            ...
            raise ImportError(
                "Please provide a valid BaseLLM or install ainktech-core['base'] package"
            ) from e
